...
----------------------------------------------------------------------
  ...
  - 프리팹을 이용한 게임옵젝트 배치 응용
    - 게임 오브젝트의 원본을 간직하고 있는 데이터
    - 복사본 생성(Rigidbody등 다양한 설정을 한 원본을 언제든지 복사하여 사용가능)
    - generate_prefab.cs
...
----------------------------------------------------------------------
  ...
  - 2D GUI(Graphic User Interface)
    - 예) 게임 스코어, 체력 게이지 등과 같은 표현
    - Update(), Start() 처럼 자동으로 호출됨
    - GUI 클래스의 함수들은 OnGUI()안에서만 사용 가능
    -
